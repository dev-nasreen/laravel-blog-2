        ...
        <div class="row mb-5">
          ...
          <div class="col-md-4">
            ...
            <div>
              ...
              <p>
                @if($setting->facebbok)<a href="{{$setting->facebbok}}"><span class="icon-facebook pt-2 pr-2 pb-2 pl-0"></span></a>@endif
                @if($setting->twitter)<a href="{{$setting->twitter}}"><span class="icon-twitter p-2"></span></a>@endif
                @if($setting->instagram)<a href="{{$setting->instagram}}"><span class="icon-instagram p-2"></span></a>@endif
                @if($setting->rss)<a href="{{$setting->rss}}"><span class="icon-rss p-2"></span></a>@endif
                @if($setting->facebbok)<a href="{{$setting->email}}"><span class="icon-envelope p-2"></span></a>@endif
              </p>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-12 text-center">
            <p>
              ...
              {{$setting->copyright}}All rights reserved |Nasreen</a>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              </p>
          </div>
        </div>
